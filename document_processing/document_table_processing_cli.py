...
help="Write column names of table eg. ['TableColumn1', 'TableColumn2', 'TableColumn3', 'TableColumn4']")
...
def azure_read_api_calling(
    ...
    try:
        ...
        print("NameError: Column names '{0}' of table should be in list".format(vertical_columns))
        return
    try:
        horizontal_columns=eval(horizontal_columns)
    except NameError:
        print("NameError: Horizontally mapped columns '{0}' of table should be in list".format(horizontal_columns))
        return
    try:
        horizontal_keywords=eval(horizontal_keywords)
    except NameError:
        print("NameError: Horizontally mapped keys of close words '{0}' within table should be in list".format(horizontal_keywords))
        return
